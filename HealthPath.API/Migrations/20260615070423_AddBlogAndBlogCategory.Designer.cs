...
namespace HealthPath.API.Migrations
{
    ...
    [Migration("20260615070423_AddBlogAndBlogCategory")]
    partial class AddBlogAndBlogCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthPath.API.Models.Admin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HealthPath.API.Models.AudioCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("audio_categories_pkey");

                    b.HasIndex(new[] { "Name" }, "idx_audio_category_name_unique")
                        .IsUnique();

                    b.ToTable("audio_categories", (string)null);
                });
            ...
            modelBuilder.Entity("HealthPath.API.Models.AudioTrack", b =>
                {
                    ...
                    b.HasIndex(new[] { "CategoryId" }, "idx_audio_category")
                        .HasFilter("(deleted_at IS NULL)");

                    b.ToTable("audio_tracks", (string)null);
                });

            modelBuilder.Entity("HealthPath.API.Models.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "CategoryId" }, "idx_blogs_category")
                        .HasFilter("(deleted_at IS NULL)");

                    b.HasIndex(new[] { "Slug" }, "uq_blogs_slug")
                        .IsUnique();

                    b.ToTable("blogs", (string)null);
                });

            modelBuilder.Entity("HealthPath.API.Models.BlogCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("blog_categories_pkey");

                    b.HasIndex(new[] { "Slug" }, "uq_blog_categories_slug")
                        .IsUnique();
            ...
            modelBuilder.Entity("HealthPath.API.Models.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "PlatformTransactionId" }, "transactions_platform_trans_id_key")
                        .IsUnique();
            ...
            modelBuilder.Entity("HealthPath.API.Models.User", b =>
                {
                    ...
                    b.HasIndex(new[] { "FacebookId" }, "idx_users_facebook_id")
                        .IsUnique()
                        .HasFilter("(facebook_id IS NOT NULL AND deleted_at IS NULL)");

                    b.HasIndex(new[] { "GoogleId" }, "idx_users_google_id")
                        .IsUnique()
            ...
            modelBuilder.Entity("HealthPath.API.Models.UserFavoriteTrack", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("user_favorite_tracks_pkey");

                    b.HasIndex("TrackId");

                    b.HasIndex(new[] { "UserId", "TrackId" }, "idx_user_favorite_track_unique")
                        .IsUnique();

                    b.ToTable("user_favorite_tracks", (string)null);
                });
            ...
            modelBuilder.Entity("HealthPath.API.Models.AudioTrack", b =>
                {
                    b.HasOne("HealthPath.API.Models.AudioCategory", "Category")
            ...
            modelBuilder.Entity("HealthPath.API.Models.Blog", b =>
                {
                    b.HasOne("HealthPath.API.Models.BlogCategory", "Category")
                        .WithMany("Blogs")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("HealthPath.API.Models.Admin", "CreatedByNavigation")
                        .WithMany()
